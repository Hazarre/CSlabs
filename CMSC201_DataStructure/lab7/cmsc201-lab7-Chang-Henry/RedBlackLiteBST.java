...
* With Assistance From 1) Algorithm 4th ed RedBlackLiteBST.java
* 2) https://stackoverflow.com/questions/5762491/how-to-print-color-in-console-using-system-out-println
*/
        ...
        for (int i = 0; i < h+1 ; i++){
            ...
            while (!q.isEmpty()){
                ...
                if (x==null){
                    ...
                    if (x.color == RED) System.out.print( "\u001B[31m" + x.key.toString()+"\u001B[0m");
                    else System.out.print(x.key.toString());
